    ...
    <main class="grid gap-5">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            <div class="p-6 bg-blue-900 border border-gray-200 rounded-lg shadow">
                <p class="mb-3 font-normal text-blue-50"> Total Riwayat Pemberian Pakan </p>
                <h5 class="mb-4 text-5xl font-bold tracking-tight text-blue-50"> <?= count($feeder) ?> </h5>
                <a href="/log" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-500 rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300">
                    Lebih lengkap
                    <svg aria-hidden="true" class="w-4 h-4 ml-2 -mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                </a>
            </div>
            <!-- Tingkat Kekeruhan Air Saat Ini Section -->
            <div class="max-w-sm w-full bg-white rounded-lg shadow dark:bg-blue-900 p-4 md:p-6">
