...
<div class="px-4 py-20 h-screen sm:ml-64">
    <main class="grid gap-5">
        ...
        <div class="p-6 border border-gray-200 rounded-lg shadow <?php if ($latestStatusId == 2) { echo 'bg-red-900'; } else { echo 'bg-green-900'; } ?>">
                <h5 class="mb-4 text-5xl font-bold tracking-tight text-green-50"> 
        ...
        <!-- <main class="grid gap-5 grid-cols-1 md:grid-cols-8">
            <div class="p-6 bg-green-800 border border-gray-200 rounded-lg shadow md:col-span-2">
                <h5 class="mb-2 text-5xl font-bold tracking-tight text-green-50">  </h5>
            ...
            <div class="p-6 bg-green-800 border border-gray-200 rounded-lg shadow md:col-span-2">
                <h5 class="mb-2 text-5xl font-bold tracking-tight text-green-50">  kg</h5>
